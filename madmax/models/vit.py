...
class ViT(Model):
    ...
    def __init__(self, model_cfg: Dict[str, Any]):
        """Initialize Vision Transformer model with configuration parameters."""
        ...
        self.entries_per_table = (self.patch_dim) ** 2 * 3  # 3 for RGB channels
        self.transformer_seq_len = math.ceil(self.image_size / self.patch_dim) ** 2
